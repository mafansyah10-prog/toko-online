...
return [
    ...
    | diberikan oleh broker kata sandi untuk upaya pembaruan kata sandi
    | yang mungkin gagal, seperti token tidak valid atau kata sandi baru tidak valid.
    |
    */

    'reset' => 'Kata sandi Anda sudah diatur ulang!',
    'sent' => 'Kami sudah mengirimkan tautan tautan atur ulang kata sandi Anda!',
