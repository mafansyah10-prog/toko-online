...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut digunakan untuk menukar atribut 'placeholder'
    | dengan sesuatu yang lebih mudah dimengerti oleh pembaca seperti
    | 'Alamat Surel' daripada 'email'. Hal ini membantu kita dalam membuat pesan menjadi lebih bersih.
    |
    */
